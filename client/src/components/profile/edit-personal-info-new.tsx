      ...
      <div className="flex space-x-3 justify-end pt-6 border-t border-white/10">
        ...
        <button 
          ...
          onClick={async (e) => {
            e.preventDefault();
            e.stopPropagation();
            console.log("[BUTTON] Save button clicked directly");
            ...
            console.log("[BUTTON] Making direct API call to:", `/api/users/${userData.id}`);
            console.log("[BUTTON] Update data:", updateData);
            ...
            try {
              ...
              console.log("[BUTTON] Calling onSave callback");
              onSave();
              console.log("[BUTTON] Profile save completed successfully");
            } catch (error) {
