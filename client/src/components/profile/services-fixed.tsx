      ...
      <NeoGlassSection className="mb-6 relative z-20">
        <div className="flex justify-between items-center mb-4">
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[525px] max-h-[95vh] overflow-y-auto neo-glass-card bg-[rgba(18,18,18,0.95)] backdrop-blur-md border-white/20" hideCloseButton>
              <DialogHeader>
