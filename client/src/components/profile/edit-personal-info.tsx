    ...
    <div className="w-full space-y-6 max-h-[70vh] overflow-y-auto pr-2 py-2 career-capsule-scrollbar">
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          disabled
          readOnly
          className="bg-[rgba(18,18,18,0.95)] backdrop-blur-md text-white/70 border-white/20 shadow-md transition-all hover:border-white/30 w-full h-10 px-3 rounded-md border placeholder-white/50 focus:border-white/50 focus:ring-2 focus:ring-white/30 focus:outline-none cursor-not-allowed"
        />
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          rows={4}
          className="bg-[rgba(18,18,18,0.95)] backdrop-blur-md text-white border-white/20 shadow-md transition-all hover:border-white/30 w-full py-3 px-3 pr-10 rounded-md border appearance-none cursor-pointer focus:border-white/50 focus:ring-2 focus:ring-white/30 focus:outline-none resize-none"
        />
      </div>
