          ...
          <div className="absolute inset-0 z-10 p-4 flex flex-col overflow-visible">
            ...
            <div className="relative mb-4">
              ...
              <div className="relative ml-1 mt-2">
                ...
                <h2 
                  className="text-xl font-bold z-10 relative mb-1 pl-2"
                  style={{
                ...
                {/* Artistic Badge for Job Title - Moved up, right below name */}
                {userData.title && (
                  <div 
                    className="relative inline-block px-2 py-1 mx-auto mb-2 mt-0.5 ml-2 overflow-visible"
                    style={{
                      transform: "rotate(-1deg)",
                    }}
                  >
              ...
              >
                ...
                >
                  ...
                  <div 
                    ...
                    style={{
                      background: `linear-gradient(45deg, ${creativeColors.mint}70, ${creativeColors.skyBlue}30)`,
                      mixBlendMode: "multiply"
                    }}
                  />
                  
                  <div 
                    className="h-5 w-5 rounded-full flex items-center justify-center relative z-10"
                    style={{
            ...
            <div className="space-y-1.5 mt-auto">
              <h3 
                className="text-xs font-bold tracking-wide mb-0.5 relative z-10 inline-block"
                style={{
                  color: creativeColors.darkText,
