...
import { StaticHashtagSuggestions } from './static-hashtag-suggestions';
  ...
  return (
    <Card className="w-full shadow-md transition-all hover:shadow-lg">
      ...
      <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <AlertDialogContent className="bg-black/20 backdrop-blur-md border border-white/10 text-white shadow-xl">
          <AlertDialogHeader>
            <AlertDialogTitle className="text-white">Complete Quest</AlertDialogTitle>
          ...
          <AlertDialogFooter>
            <AlertDialogCancel className="bg-black/30 text-white border-white/10 hover:bg-black/40 backdrop-blur-sm">Cancel</AlertDialogCancel>
            <AlertDialogAction onClick={handleComplete} className="bg-white/5 text-white hover:bg-white/10 border-white/10 backdrop-blur-sm">
              Complete Quest
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
