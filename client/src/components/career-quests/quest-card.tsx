  ...
  return (
    <Card className="w-full shadow-md transition-all hover:shadow-lg">
      ...
      <AlertDialog open={confirmOpen} onOpenChange={setConfirmOpen}>
        <AlertDialogContent className="bg-gray-900/90 border-white/10 text-white backdrop-blur-md">
          <AlertDialogHeader>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction onClick={handleComplete} className="bg-white/20 text-white hover:bg-white/30 border-white/10">
              Complete Quest
            </AlertDialogAction>
          </AlertDialogFooter>
        </AlertDialogContent>
