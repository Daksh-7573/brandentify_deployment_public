...
import { Zap, Settings, Menu, X, Home, Search, Bot, User, MapPin, Play } from "lucide-react";
          ...
          <div className="flex items-center">
            ...
            <div className="hidden md:flex space-x-6">
              ...
              <Button
                ...
                size="sm" 
                className={`flex items-center gap-2 font-medium px-3 py-2 h-auto ${
                  isActive('/animation-demo') 
                    ? 'text-primary bg-primary/5 hover:bg-primary/10' 
                    : 'text-gray-800 hover:text-primary hover:bg-gray-50'
                }`}
                onClick={() => setLocation('/animation-demo')}
              >
        ...
        <div className="md:hidden bg-white border-b border-gray-200 shadow-lg">
          <div className="px-4 pt-3 pb-4 space-y-2">
            ...
            <Button
              ...
              onClick={() => {
                setLocation('/animation-demo');
                setIsMobileMenuOpen(false);
              }}
            >
              <Play className="h-4 w-4 mr-3 ml-0.5" />
              <span>Animations</span>
            </Button>
