...
export default function ProfileSteps({ 
        ...
        case 3: // Services
          ...
          if (userData?.id) {
            try {
              ...
              // Store confirmation of success to prevent unnecessary updates
              ...
              // If sync failed, at least try to save whatIOffer directly
              ...
              try {
                if (userData?.id) {
                  ...
                  toast({
                    ...
                    description: "Your services were saved. Services may need to be updated later.",
                    variant: "default"
                  });
  ...
  const renderSkillsStep = () => {
    ...
    const addSkill = () => {
      ...
      setFormData(prev => {
        // Make sure prev.skills is always an array
