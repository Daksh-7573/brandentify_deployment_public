...
const Chat: React.FC<{ userId: number }> = ({ userId }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-3 sm:gap-4 md:gap-6 h-full overflow-hidden">
      ...
      <div className={`${currentConversation || filter === 'musk' ? 'hidden md:block' : 'block'} md:w-1/3 lg:w-1/4 xl:w-1/5 h-full md:min-w-[280px] lg:min-w-[300px] overflow-hidden flex flex-col`}>
