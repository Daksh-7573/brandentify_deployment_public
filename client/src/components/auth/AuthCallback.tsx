 ...
 * Handles Google OAuth redirect results and creates/updates Brandentify user accounts
 */
    ...
    const handleAuthCallback = async () => {
      try {
        ...
        if (result && result.user) {
          ...
          setMessage('Accessing your Brandentify account...');
          ...
          setStatus('success');
          setMessage(`Welcome to Brandentify, ${userData.name || userData.email}!`);

          toast({
            title: 'Welcome to Brandentify!',
            description: 'Your account has been created successfully.',
          });

          // Redirect to dashboard or onboarding
          const returnUrl = userData.profileCompleted < 95 ? '/onboarding' : (sessionStorage.getItem('auth_return_url') || '/industry-pulse');
          setTimeout(() => {
