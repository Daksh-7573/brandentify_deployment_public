        ...
        <div className="space-y-6">
          ...
          {project.description && (
            <div className="prose max-w-none">
              <p className="break-all leading-relaxed" style={{ color: '#6B7F75' }}>{project.description}</p>
            </div>
          )}
          ...
          >
            <Card className="border-0 shadow-lg" style={{ backgroundColor: '#C9B5A0', borderRadius: '24px' }}>
              <CardContent className="p-8 md:p-12">
                ...
                <p className="break-all text-lg leading-relaxed italic" style={{ color: '#2D5F4F' }}>{userInfo.visionStatement}</p>
              </CardContent>
            </Card>
          </motion.section>
        )}
