        ...
        <section className="py-20 px-4 border-t" style={{ borderColor: colors.platinumEdgeGlow }}>
          <div className="max-w-6xl mx-auto">
            ...
            {userInfo.aboutMe && (
              ...
              >
                <p className="break-all text-xs uppercase tracking-widest font-semibold mb-3" style={{ color: colors.executivePurple }}>
                  Executive Summary
                </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
                {userInfo.visionStatement && (
                  ...
                  >
                    ...
                    <p className="break-all text-sm leading-relaxed">{userInfo.visionStatement}</p>
                  </motion.div>
                )}
                ...
                {userInfo.missionStatement && (
                  ...
                  >
                    <p className="break-all text-xs uppercase tracking-widest font-semibold mb-3" style={{ color: colors.platinumSilver }}>
                      Mission
                    </p>
