...
export default function MinimalistPro({ userInfo, userSkills, userExperiences, userProjects }: MinimalistProProps) {
  ...
  return (
    <Card className="overflow-hidden shadow-lg" style={{ background: "#F5F7FA" }}>
      {/* Header with clean elegant styling */}
      <div className="h-24 bg-[#0044CC] flex items-center justify-between px-8">
              ...
              {sortedSkills.slice(0, 6).map((skill) => (
                <div key={skill.id} className="fade-in">
                  ...
                  <div className="h-1.5 w-full bg-[#EAEAEA] rounded-full overflow-hidden">
                    <div 
                      className="h-full bg-[#0044CC] rounded-full" 
          ...
          <div className="mb-10 fade-in">
            ...
            <div className="space-y-6">
              {sortedExperiences.slice(0, 3).map((exp) => (
                <div key={exp.id} className="bg-white p-5 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 flex gap-4">
          ...
          <div className="fade-in">
            ...
            <div className="grid grid-cols-2 gap-4">
              {userProjects.slice(0, 4).map((project) => (
                <div key={project.id} className="bg-white p-4 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
