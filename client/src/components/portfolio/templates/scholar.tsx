          ...
          <div className="flex flex-col md:flex-row md:items-center gap-8">
            ...
            <div className="text-center md:text-left flex-1">
              ...
              {(userInfo && userInfo.company) && (
                <div className="flex items-center justify-center md:justify-start text-gray-600 mb-3 fade-in-up delay-150">
                  <span className="text-sm">
                    {userInfo.title ? `${userInfo.title}` : ''} {userInfo.title && userInfo.company ? 'at' : ''} {userInfo.company}
                  </span>
                </div>
              )}
