        ...
        <div className="container px-6 z-10 relative">
          <div className="hero-content text-center">
            ...
            >
              ...
              >
                <p className="break-all text-lg">{aboutContent}</p>
              </motion.div>
            </motion.div>
          </div>
        </div>
            ...
            <div className="max-w-4xl mx-auto space-y-6">
              {tagline && (
                ...
                >
                  ...
                  <p className="break-all text-lg italic text-muted-foreground">"{tagline}"</p>
                </motion.div>
              )}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {visionStatement && (
                    ...
                    >
                      ...
                      <p className="break-all text-muted-foreground leading-relaxed">{visionStatement}</p>
                    </motion.div>
                  )}
                  {missionStatement && (
                    <motion.div
