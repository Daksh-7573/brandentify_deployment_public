          ...
          <NeoGlassSection className="text-center mb-12">
            <div className="space-y-6">
              ...
              <p className="text-xl md:text-2xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
                AI-Powered Career Development Platform that transforms your
                professional journey with intelligent insights and personalized
                guidance
              </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Confused about your next move? Get smart, personalized career
                  advice instantly.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Talk to AI mentors modeled after industry legends — anytime,
                  anywhere.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Upload your resume and get instant feedback, scoring, and
                  styling tips.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Find out which skills you need to grow in your dream career
                  path.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Build a professional network that actually helps — not just
                  connects.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Showcase your skills with real, categorized projects
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Add internships, jobs, and learnings — everything that shapes
                  your journey.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Set career goals and let AI guide you step-by-step to reach
                  them.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Level up your career with gamified challenges and win badges
                  as you grow.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Get alerts for jobs, collaborations, and career opportunities
                  in your domain.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Get reactions and endorsements that boost your credibility —
                  not just likes.
                </p>
              </div>
              ...
              <div className="neo-glass-card p-6 rounded-lg transition-all duration-300 hover:scale-105">
                ...
                <p className="text-gray-300 leading-relaxed">
                  Stay ahead with personalized industry news, tips, and
                  AI-powered posts.
                </p>
              </div>
            </div>
          ...
          <NeoGlassSection className="text-center mb-20">
            <div className="space-y-6">
              ...
              <p className="text-xl text-gray-300 max-w-2xl mx-auto">
                Join thousands of professionals who are already accelerating
                their careers with AI-powered insights
              </p>
              {!isAuthenticated && (
                <Button
                  onClick={() => setLocation("/auth")}
