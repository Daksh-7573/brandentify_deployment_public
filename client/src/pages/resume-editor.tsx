...
export default function ResumeEditor() {
  ...
  // Removed localStorage dependency for parsed resume data - data should come from backend
          ...
          <CardContent>
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              <TabsList className="grid w-full grid-cols-5 h-auto p-1 tabs-list-mobile neo-glass-tabs">
                <TabsTrigger value="personal-info" className="flex items-center justify-center gap-1 text-xs px-2 py-2 sm:text-sm sm:px-3 tabs-trigger-mobile">
                  <User2 className="h-4 w-4" />
                  <span className="hidden sm:inline">Personal</span>
                </TabsTrigger>
                <TabsTrigger value="experience" className="flex items-center justify-center gap-1 text-xs px-2 py-2 sm:text-sm sm:px-3 tabs-trigger-mobile">
                  <BriefcaseBusiness className="h-4 w-4" />
                  <span className="hidden sm:inline">Experience</span>
                </TabsTrigger>
                <TabsTrigger value="education" className="flex items-center justify-center gap-1 text-xs px-2 py-2 sm:text-sm sm:px-3 tabs-trigger-mobile">
                  <GraduationCap className="h-4 w-4" />
                  <span className="hidden sm:inline">Education</span>
                </TabsTrigger>
                <TabsTrigger value="skills" className="flex items-center justify-center gap-1 text-xs px-2 py-2 sm:text-sm sm:px-3 tabs-trigger-mobile">
                  <Trophy className="h-4 w-4" />
                  <span className="hidden sm:inline">Skills</span>
                </TabsTrigger>
                <TabsTrigger value="projects" className="flex items-center justify-center gap-1 text-xs px-2 py-2 sm:text-sm sm:px-3 tabs-trigger-mobile">
