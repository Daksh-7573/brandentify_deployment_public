    ...
    >
      ...
      <div className="flex flex-1 overflow-hidden pt-16 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          <Card className="bg-gradient-to-b from-gray-800/30 to-gray-900/20 backdrop-blur-sm border border-white/10 p-8 lg:col-span-1" data-testid="card-overall-score">
          ...
          <Card className="bg-gradient-to-b from-gray-800/30 to-gray-900/20 backdrop-blur-sm border border-white/10 p-8 lg:col-span-2" data-testid="card-component-breakdown">
        ...
        {brandScore.aiSuggestions.length > 0 && (
          <Card className="bg-gradient-to-b from-gray-800/30 to-gray-900/20 backdrop-blur-sm border border-white/10 p-8 mb-6" data-testid="card-ai-suggestions">
            <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
        ...
        <Card className="bg-gradient-to-b from-gray-800/30 to-gray-900/20 backdrop-blur-sm border border-white/10 p-8" data-testid="card-all-suggestions">
          <h2 className="text-2xl font-bold text-white mb-6 flex items-center gap-2">
