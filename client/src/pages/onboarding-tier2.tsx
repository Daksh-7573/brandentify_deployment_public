...
interface OnboardingTier2Props {
...
export default function OnboardingTier2({ 
  onComplete, 
  onBack,
  onSkip
}: OnboardingTier2Props) {
          ...
          <NeoGlassSection className="p-8 sm:p-12">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-white/60 max-w-xl mx-auto text-sm">
                Add your key skills and what you can offer to potential connections
              </p>
            </div>
            ...
            <div className="space-y-8 mb-8">
              ...
              <div className="space-y-2">
                <Label htmlFor="whatIOffer" className="text-white font-medium">
                  What I Offer <span className="text-white/60 text-sm font-normal">(Optional)</span>
                </Label>
                <Textarea
                  id="whatIOffer"
                  value={whatIOffer}
                  ...
                  maxLength={500}
                  data-testid="textarea-what-i-offer"
                />
                <p className="text-white/50 text-xs">
