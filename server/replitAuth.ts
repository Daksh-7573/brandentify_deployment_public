...
export function getSession() {
  ...
  return session({
    secret: process.env.SESSION_SECRET || "dev-session-secret-replace-in-prod",
    store: sessionStore,
    resave: false,
...
async function upsertUser(
  ...
  await storage.upsertUser({
    ...
    name: `${claims["first_name"] || ''} ${claims["last_name"] || ''}`.trim() || `User ${claims["sub"]}`,
    profileImageUrl: claims["profile_image_url"],
    password: null,
    phoneNumber: null,
    photoURL: claims["profile_image_url"],
    title: null,
    aboutMe: null,
    location: null,
    industry: null,
