 ...
 * GET /api/brands-of-the-day/enhanced-user/:userId
 */
router.get("/api/brands-of-the-day/enhanced-user/:userId", async (req: Request, res: Response) => {
  try {
    const userId = parseInt(req.params.userId, 10);
    ...
    res.status(500).json({ message: "Failed to get user data for brand of the day" });
  }
});
