...
export const users = pgTable("users", {
  ...
  selectedPortfolioLayout: text("selected_portfolio_layout").default("corporate-executive"), // User's preferred portfolio template
...
export const projects = pgTable("projects", {
  ...
  // Client endorsements stored in separate projectEndorsements table
  createdAt: timestamp("created_at").defaultNow(),
  updatedAt: timestamp("updated_at").defaultNow(),
});
